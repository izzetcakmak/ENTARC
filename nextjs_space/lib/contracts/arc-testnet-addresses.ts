...
/**
 * Chain Parameters
 * Reads the active network from arc-network.ts (mainnet or testnet).
 */
import {
  ARC_CHAIN_ID,
  ARC_RPC_URL,
...
export const ARC_CHAIN_PARAMS = {
  ...
  CHAIN_NAME: NETWORK_LABEL,
  RPC_URL: ARC_RPC_URL,
  EXPLORER_URL: ARC_EXPLORER_URL,
  NATIVE_CURRENCY: ARC_NATIVE_CURRENCY,
};

/**
 * Protocol Configuration Parameters from Arc Network
 */
